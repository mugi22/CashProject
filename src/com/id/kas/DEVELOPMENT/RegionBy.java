...
@Controller
public class RegionBy extends AbstractListScreen{

	

	@RequestMapping(value="/regionBy.htm",method=RequestMethod.GET)
	@Override
	...
	@RequestMapping(value="/regionBy.htm",method=RequestMethod.POST)
	@Override
