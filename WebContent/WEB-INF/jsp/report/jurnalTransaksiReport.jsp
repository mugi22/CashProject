...
<table id="myData" align="center" width="90%" cellpadding="0" cellspacing="0"  style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;">
	<thead>            
    	<tr>
                    ...
                    <th style="font-weight:bold" align="center" class="cfg_header" >AmountD</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >AmountK</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >Waktu</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >TglTransaksi</th> 
                    <th style="font-weight:bold" align="center" class="cfg_header" >IdJurnalTransaksi</th> 
...
<script type="text/javascript">
	...
	$("document").ready(function(){
		var uri ='jurnalTransaksiDataReport.htm?';
        ...
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.jurnalId,0,'.',',') + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.tglPosting + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.amountD,0,'.',',') + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.amountK,0,'.',',') + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.waktu + "</font></div></td>"+
        "<td align='left'> <div class='cfg_detail'><font class='f_boldhd'>" +  value.tglTransaksi + "</font></div></td>"+
        "<td align='right'> <div class='cfg_detail'><font class='f_boldhd'>" + accounting.formatNumber(value.idJurnalTransaksi,0,'.',',') + "</font></div></td>"+

	                		     "</tr>");
	                 $("#myData").append(row);
	                 no++;
	              });
				var z =  $("<tr> <td colspan='10' align='left' style='background-color:#CCF;'> <div class='cfg_detailx'><font class='f_boldhd'>" +'T O T A L'+ "</font></div></td></tr>");
				$("#myData").append(z);
			}
		});
	});
