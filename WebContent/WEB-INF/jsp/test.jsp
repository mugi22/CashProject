...
<!-- **********************TABLE RESULT************************************** -->
        <table id="dg" title="TEST" class="easyui-datagrid" style="width:100%;"
...
/* ---- testedit*/
	function doEdit() {
		...
		if (row) {
			...
			$('#fm').form('clear');
			$('#fm').form('load', row);
			url = 'testEdit.htm';//?param='+row.kodeProvinsi+'&param2='+row.kodeKabupaten; //SESUAIKAN
			onEdit();
		}
	}
/*-- testtampil*/
	function doShow() {
		...
		if (row) {
			...
			$('#fm').form('clear');
			$('#fm').form('load', row);
			url = 'testEdit.htm';//?param='+row.kodeProvinsi+'&param2='+row.kodeKabupaten;
			onShow();
		}
	}
